...
export const INFO_ITEMS = [
  ...
  {
    id: 'kodkod',
    label: 'משחקים מתנת קודקוד',
    title: 'משחקים מתנת קודקוד',
    lines: [
      'לא היה בילדות שלנו חלום יותר גדול מלזכות במשחק קופסה מתנת קודקוד (חוץ מלהיות אסטרונאוט)',
    ],
  },
  {
    id: 'mystery-3',
    ...
    title: 'הפתעות נוספות',
    lines: [
      'באירוע עצמו יחכו לכם הפתעות נוספות, כולל אורחים מיוחדים נוספים!',
    ],
  },
] as const
